...
let geojsonPath = 'https://raw.githubusercontent.com/LCIWaterProjects/lacwatergovmap/main/data/LACwaterdata.geojson';
let geojson_data;
let geojson_layer;
...
function createLegend(){
    legend.onAdd = function (map) {
        ...
        if(fieldtomap == 'GovCode'){
            ...
            '<div style="background-color: #6C91BF"></div>City/Municipal<br>' +
...
function createInfoPanel(){
    ...
    info_panel.update = function (properties) {
        ...
        if(properties){
            ...
            <br><b>Service Connections:</b> ${properties['PanelConnect_PanelConnections']}
